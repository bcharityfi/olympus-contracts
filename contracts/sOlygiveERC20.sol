...
contract sOlygive is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Olygive", "sOGV", 9) ERC20Permit() {
    ...
    /**
        @notice increases sOGV supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sOGV
