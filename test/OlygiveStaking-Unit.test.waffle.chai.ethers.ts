...
describe('Olygive Staking', () => {
    ...
    beforeEach(async () => {
        ...
        OLY = await ethers.getContractFactory('OlygiveERC20TOken');
        oly = await OLY.deploy();

        Staking = await ethers.getContractFactory('OlygiveStaking');
        ...
        sOLY = await ethers.getContractFactory('sOlygive');
